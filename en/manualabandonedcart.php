...
return [
    'title' => 'Manual Abandoned Cart Recovery',
    'tabs' => [
        'carts' => [
            'title' => 'Carts',
            'description' => 'Note: Abandoned carts without phone number are automatically hidden. Send manual messages faster by opening our app on your mobile phone browser, or by using WhatsApp Desktop app. Go to Settings tab to configure.',
            'table' => [
                'order' => 'Order',
                'client' => 'Client Name',
